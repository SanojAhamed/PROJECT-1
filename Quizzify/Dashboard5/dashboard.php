...
<style>
        ...
        h3 {
            ...
            padding: 18px; /* Set the desired padding */
        }
    </style>
<body>
...
<br><br>
        ...
        <small>User</small>
        <li><a href="http://localhost/Quizzify/Quizzify/quizcrud/quiz/index.php">All user</a></li>
